...
import com.job.view.ChooseHr;
import com.job.view.showwork_style;
...
public class ChangePassword_en extends Activity {
				...
				AsyncTask<Void,Void,Boolean> ATgetTask = new AsyncTask<Void, Void, Boolean>() {
						...
						protected void onPostExecute(Boolean Bool){
							if(Bool==true){
								...
								new AlertDialog.Builder(ChangePassword_en.this)  
